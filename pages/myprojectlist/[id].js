...
export default function Home() {
    ...
    useHotkeys('ctrl+e, meta+e', () => setShowModal('export2'), { preventDefault: true }, [
        tableDict,
        linkDict,
    ]);
    ...
    return (
        <div className="graph">
            ...
            <Nav setShowModal={setShowModal} setShowDrawer={setShowDrawer} setName={setNameS} />
            ...
            <ExportModal showModal={showModal} onCloseModal={() => setShowModal('')} name={name} />
